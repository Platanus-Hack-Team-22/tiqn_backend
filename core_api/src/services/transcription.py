...
async def transcribe_audio_stream_azure(
    ...
    emergency_phrases = [
        "Hatzalah", "emergencia", "ambulancia", "consciente", "inconsciente",
        "respira", "no respira", "alerta", "verbal", "dolor", "AVDI",
        "paciente", "direccion", "comuna", "Las Condes", "Providencia",
        "Vitacura", "Santiago", "Ñuñoa", "Apoquindo", "Los Leones",
    ]
